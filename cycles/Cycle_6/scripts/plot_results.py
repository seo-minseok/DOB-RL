...
METRIC_META = {
    ...
    **{f'res_err_{n}': ('Abs Error', f'Residual Error [{n}]', None) for n in _OBS_NAMES},
    # MBRL-specific metrics
    'model_loss_avg':      ('Loss',              'Model Loss (avg)',           None),
    'horizon_length':      ('Steps',             'Rollout Horizon Length',     None),
    'real_buffer_size':    ('Size',              'Real Buffer Size',           None),
    'model_buffer_size':   ('Size',              'Model Buffer Size',          None),
    'q1_avg':              ('Q Value',           'Q1 Avg',                     None),
    'q2_avg':              ('Q Value',           'Q2 Avg',                     None),
    'target_q_avg':        ('Q Value',           'Target Q Avg',               None),
    'model_pred_error_avg':('Error',             'Model Prediction Error (avg)',None),
    **{f'model_err_{n}': ('Abs Error', f'Model Error [{n}]', None) for n in _MBRL_OBS_NAMES},
}
