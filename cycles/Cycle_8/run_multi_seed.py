...
METRIC_KEYS = [
    ...
    'q_pred_avg', 'target_q_avg', 'env_return', 'eval_reward_avg',
]


def _run_single(args):
    run_idx, checkpoint_dir, use_uncertainty_sampling = args
...
def main():
    ...
    target_score = 90.0   # MountainCarContinuous solved threshold
    ...
    print('=' * 60)
    print(f'DOB-MBRL Multi-Seed Training  (runs={num_runs}, total_episodes={cfg.total_episodes})')
    ...
    args_list   = [(i + 1, args.checkpoint_dir, use_uncertainty_sampling)
