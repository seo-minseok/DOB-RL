"""
run_multi_seed.py — BipedalWalker DOB-MBRL (TD3) 멀티 시드 병렬 학습 진입점
Usage:
  python run_multi_seed.py --checkpoint-dir ./checkpoints --num-seeds 8
"""
import argparse
import csv
...
def main():
    ...
    target_score = 300.0   # BipedalWalker-v3 solved 기준

    print('=' * 60)
    print(f'DOB-MBRL BipedalWalker (TD3) Multi-Seed Training  (runs={num_runs}, ep={max_episodes})')
    print('=' * 60)
